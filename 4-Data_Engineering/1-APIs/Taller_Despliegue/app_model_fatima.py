...
os.chdir(os.path.dirname(__file__))# con estoy estoy cogiendo la ruta donde sta m script.
...
app.config["DEBUG"] = True # cuando ya tenemos la version buena lo cambiamos a False(cuando este en producción)
